...
const LoginIntentHandler = {
    ...
    async handle(handlerInput) {
        ...
        const speechText = 'Okay. To authenticate, what\'s your full name?';
        return handlerInput.responseBuilder
            .speak(speechText)
            // .reprompt("What would you like/?")
            .getResponse();
...
const SetupIntentHandler = {
    ...
    handle(handlerInput) {
        const speechText = 'Alright, let\'s set up a new voice profile for this device.';
        return handlerInput.responseBuilder
            .speak(speechText)
            //.reprompt('add a reprompt if you want to keep the session open for the user to respond')
            .getResponse();
...
const HelpIntentHandler = {
    ...
    handle(handlerInput) {
        const speechText = 'To login, say "login". To set up authentication, say "set up".';
